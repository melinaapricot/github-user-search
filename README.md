...
- List of public repos with pagination
...
- Each component has it's own .scss file.
- Project aliases (@components, @hooks, @styles) are set up in both tsconfig.json and vite.config.ts.
